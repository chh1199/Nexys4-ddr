...
set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { swt[8] }]; #IO_L24N_T3_34 Sch=sw[8]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports { swt[9] }]; #IO_25_34 Sch=sw[9]
...
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { testprobe }]; #IO_L20N_T3_A19_15 Sch=ja[1]
